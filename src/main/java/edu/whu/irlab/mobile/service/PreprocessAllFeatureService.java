 ...
 */
public class PreprocessAllFeatureService extends AbstractPreprocessService{
    private static Logger logger = LoggerFactory.getLogger(PreprocessAllFeatureService.class);

    private static PreprocessAllFeatureService instance = new PreprocessAllFeatureService();

    private PreprocessAllFeatureService(){}

    public static PreprocessAllFeatureService getInstance(){
        return instance;
    }
