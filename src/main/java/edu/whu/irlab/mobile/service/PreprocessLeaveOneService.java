 ...
 */
public class PreprocessLeaveOneService extends AbstractPreprocessService {
    private static Logger logger = LoggerFactory.getLogger(PreprocessLeaveOneService.class);

    private static PreprocessLeaveOneService instance = new PreprocessLeaveOneService();
    ...
    public static void setRemoveIndex(int removeIndex) {
        PreprocessLeaveOneService.removeIndex = removeIndex;
    }

    private PreprocessLeaveOneService() {
    }

    public static PreprocessLeaveOneService getInstance(){
        return instance;
    }
